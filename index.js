...
*/
const A187 = 'BOT'; // JANGAN UBAH-UBAH INFO!!!
const instagram = 'https://instagram.com/faizatkus'; // JANGAN UBAH-UBAH INFO!!!
...
conn.sendMessage(id, ' _Papepape Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
else if (text == 'P'){
conn.sendMessage(id, ' _Papepape Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
...
conn.sendMessage(id, 'Asstagfirullahalazim kamu itu berdosa banget' ,MessageType.text);
}
else if (text == 'Anjing'){
...
conn.sendMessage(id, ' _Najis🤢_ ' ,MessageType.text);
}
else if (text == 'Mas'){
conn.sendMessage(id, ' _Iyah aku disini kak...ada yang bisa kami bantu? Ketik *#help* untuk melihat fitur bot kami🙏_ ' ,MessageType.text);
}
  ...
  var teks = text.replace(/!nulis /, '')
    ...
    .then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, 'Bntr', MessageType.text)
